""" The CW2 transfer attack """
import torch
from adversarial_attack_defense_power_system.attacks.attacks_white.cw2 import carlini_wagner_l2_attack


def carlini_wagner_l2_attack_transfer(sample_x, sample_y, net, surrogate_net, attack_config=None):
    ...
    sample_x_adv, success = carlini_wagner_l2_attack(sample_x, sample_y, surrogate_net, attack_config=attack_config)
