""" The BIM transfer attack """
import torch
from adversarial_attack_defense_power_system.attacks.attacks_white.bim import bim_attack


def bim_attack_transfer(sample_x, sample_y, net, surrogate_net, attack_config=None):
    ...
    sample_x_adv, success = bim_attack(sample_x, sample_y, surrogate_net, attack_config=attack_config)
