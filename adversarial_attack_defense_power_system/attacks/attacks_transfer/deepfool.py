""" The DeepFool transfer attack """
import torch
from adversarial_attack_defense_power_system.attacks.attacks_white import deepfool_attack


def deepfool_attack_transfer(sample_x, sample_y, net, surrogate_net, attack_config=None):
    ...
    sample_x_adv, success = deepfool_attack(sample_x, sample_y, surrogate_net, attack_config=attack_config)
