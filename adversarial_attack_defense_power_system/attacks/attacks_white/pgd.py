...
def pgd_attack(sample_x, sample_y, net, attack_config=None):
    ...
    # Perform attack
    sample_x_adv = sample_x.clone()
    # Starting at a uniformly random point
    sample_x_adv = sample_x_adv + torch.empty_like(sample_x_adv).uniform_(-eps, eps)
    r_tot = sample_x_adv - sample_x
