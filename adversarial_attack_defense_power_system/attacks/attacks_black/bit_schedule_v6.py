...
def bit_schedule_attack_v6(model, input_image, input_label, attack_config):
    """
    ...
    lr = 0.05
    print(f"Starting Bit Schedule Attack V6, with max_queries: {max_queries}, epsilon_l2: {epsilon_l2}, learning_rate: {lr}.")
    setup_random_seeds()
    # init the variables
